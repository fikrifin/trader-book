...
<body class="min-h-screen bg-gray-50 text-gray-900">
    <main class="mx-auto flex min-h-screen max-w-3xl items-center justify-center px-6">
        <div class="w-full rounded-2xl border border-gray-200 bg-white p-8 text-center shadow-sm">
            <p class="text-sm font-semibold uppercase tracking-wider text-brand-600">Error 500</p>
            <h1 class="mt-2 text-3xl font-bold">Terjadi Kesalahan Server</h1>
            <p class="mt-3 text-sm text-gray-600">Coba refresh halaman dalam beberapa saat.</p>
