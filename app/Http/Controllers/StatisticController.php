...
class StatisticController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Statistics/Index', [
            ...
            'performance_by_pair' => $service->performanceByPair(),
            'performance_by_setup' => $service->performanceBySetup(),
            'performance_by_session' => $service->performanceBySession(),
            'performance_by_timeframe' => $service->performanceByTimeframe(),
            'performance_by_day_of_week' => $service->performanceByDayOfWeek(),
            'net_vs_gross' => $service->netVsGross(),
